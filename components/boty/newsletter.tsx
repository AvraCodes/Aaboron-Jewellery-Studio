    ...
    <section className="py-24 bg-primary">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="font-display text-4xl leading-tight text-primary-foreground mb-4 text-balance md:text-7xl">
            New pieces, first
          </h2>
          ...
          {isSubscribed ? (
            <div className="inline-flex items-center gap-3 bg-primary-foreground/10 backdrop-blur-sm rounded-full px-8 py-4">
              ...
              <span className="text-primary-foreground">You&apos;re on the list — thank you.</span>
            </div>
          ) : (
